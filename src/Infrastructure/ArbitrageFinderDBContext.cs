...
namespace ArbitrageFinder.Infrastructure
{
    using System;
    using System.Linq;
    ...
    using ArbitrageFinder.Infrastructure.EntityConfiguration;
    using MediatR;
    using Microsoft.EntityFrameworkCore;
    using Microsoft.Extensions.Configuration;

    /// <summary>
    /// <see cref="ArbitrageFinderDBContext"/>
    /// </summary>
    /// <seealso cref="DbContext"/>
    /// <seealso cref="IUnitOfWork"/>
    public class ArbitrageFinderDBContext : DbContext, IUnitOfWork
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ArbitrageFinderDBContext"/> class.
        /// </summary>
        /// <param name="configuration">The configuration.</param>
        /// <param name="mediator">The mediator.</param>
        public ArbitrageFinderDBContext(
            IConfiguration configuration,
            IMediator mediator,
            DbContextOptions<ArbitrageFinderDBContext> options)
            : base(options)
        {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder
                ...
                .UseMySql(
                    this.configuration.GetSection(ArbitrageFinderDBContext.DatabaseConnectionSection).Value,
